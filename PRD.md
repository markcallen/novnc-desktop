...
| ID            | Requirement covered | Observable outcome                                                                                                                                                                        |
| ------------- | ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AC-DESKTOP-01 | FR-5.1, FR-5.2      | VNC canvas renders the desktop; smoke marker terminal is visible                                                                                                                          |
...
| `smoke_test_marker_enabled` | `false`                                               | Renders a bright-green terminal for smoke test canvas verification                         |
